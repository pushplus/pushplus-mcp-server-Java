...
3. 在 target 目录中启动程序，命令：`PUSHPLUS_TOKEN=你的token java -Dlogging.pattern.console= -jar pushplus-mcp-1.0.1.jar`
  ...
  "mcpServers": {
    "pushplus-mcp-server": {
      ...
      "args": [
        ...
        "-jar",
        "yourFilePath\\pushplus-mcp-1.0.1.jar"
      ],
      "env": {
...
- `yourFilePath\\pushplus-mcp-1.0.1.jar` 修改为自己本地的文件路径
